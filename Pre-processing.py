...
def read_file_name(path):
    ...
    file_name = []
    for file in files:
        if file[-3:] == "edf" and (file[4] == "6" or file[4] == "7"):
...
#scio.savemat('./normtraining_set4.mat', training_set)
#scio.savemat('./normvalidation_set4.mat', validation_set)
#scio.savemat('./normtest_set4.mat', test_set)
